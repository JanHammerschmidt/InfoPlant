...
class Circle(object):
    ...
    def __init__(self, mac, comchan, attr=None):
        ...
        def_attr = {'name': 'circle', 'always_on':'True','location':'unknown','production':'False','loginterval':'10'}
        self.attr = {} if attr is None else attr
        for key,val in def_attr.items():
    ...
    def read_node_table(self):
        ...
        return [n for n in nodetable if n != 'FFFFFFFFFFFFFFFF']
